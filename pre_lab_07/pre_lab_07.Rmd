...
```{r echo=FALSE}
#census_api_key("9515735948613ff46c04463438db97a4b0480b4a", install=TRUE)
```
...
**Answer** The answer keeps just telling me "Getting data" but loading it isn't necessarily working? 
...
**Task** Arrange md_zips_with_acs by estimate showing the highest median household income first. What questions do you have about these top zip codes? **Answer** What occupations are most common within the top zipcodes? 
