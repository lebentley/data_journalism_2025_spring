...
**Q2** narcotic equip possess or use
...
**A3** adult permits under 16 yoa to possess weapon
...
**A4** A lot of the charges that are tied for least common are really specific or rare circumstances. If you look at the most common offenses, they are not nearly as specific as the least common. 
...
okaloosa_court_charges |> 
  ...
  arrange(desc(count_prosecutors))
...
**A9** I would talk to the defendants with the largest average amount of fines. We could potentially clean the data to understand what the story is. I would also make sure to talk to defendants who have a smaller amount of cases with a larger average fine amount. Furthermore, we could also specify the data even more by adding a category as to what crime they committed that resulted in the largest amount fined.